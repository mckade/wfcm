 ...
 *
 * NoteTransition controls probabilities related to going from one note
 * to another. The probabilities are constrained by the notes in the sample.
 * If a transition is seen between two notes 'distance' notes apart, the
 * probability of those two notes appearing together in the output increases.
